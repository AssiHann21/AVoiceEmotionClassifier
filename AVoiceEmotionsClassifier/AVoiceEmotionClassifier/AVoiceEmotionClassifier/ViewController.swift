...
//  AVoiceEmotionClassifier
//
//  Created by Assiatou Hann on 5/31/20.
//  Copyright © 2020 Assiatou Hann. All rights reserved.
//
...
class ViewController: UIViewController, AVCaptureAudioDataOutputSampleBufferDelegate {
    ...
    lazy var output = ["happy", "sad", "angry", "fear", "neutral"]
    ...
    private func getInference() {
        ...
        _ = Timer.scheduledTimer(withTimeInterval: 5, repeats: true) { t in
            ...
            for windowIndex in 0..<Int(windowNumber) {
                ...
                let modelInput = MySoundClassifier_1Input(audioSamples: audioData)
